...
+ (void)setDefaultConfig
{
    ...
    [defaults setObject:kSSServiceIP forKey:kShadowsocksIPKey];
    [defaults setObject:kSSServicePort forKey:kShadowsocksPortKey];
    [defaults setObject:kSSServicePW forKey:kShadowsocksPasswordKey];
